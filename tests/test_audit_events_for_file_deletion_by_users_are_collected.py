...
@patch.object(CISAudit, "_shellexec", mock_audit_events_for_file_deletion_by_users_are_collected_pass)
...
@patch.object(CISAudit, "_shellexec", mock_audit_events_for_file_deletion_by_users_are_collected_fail)
