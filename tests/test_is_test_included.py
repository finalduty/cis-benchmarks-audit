...
def test_id_included(caplog):
    ...
    test_id = '1.1'
    test_level = 1
    custom_config = Namespace(includes=['1.1'], excludes=None, level=0, log_level='DEBUG')
    test = CISAudit(config=custom_config)
        
    result = test.test_is_included(test_id, test_level)
...
def test_id_excluded(caplog):
    ...
    test_id = '1.1'
    test_level = 1
    custom_config = Namespace(includes=None, excludes=['1.1'], level=0, log_level='DEBUG')
    test = CISAudit(config=custom_config)
...
def test_id_not_excluded(caplog):
    ...
    result = test.test_is_included(test_id=test_id, test_level=test_level)
...
def test_child_id_included(caplog):
    ...
    test_id = '1.1'
    test_level = 1
    custom_config = Namespace(includes=['1.1.1'], excludes=None, level=0, log_level='DEBUG')
    test = CISAudit(config=custom_config)
...
def test_level_matches_testing_level(caplog):
    ...
    test_id = '1.1'
    test_level = 1
    custom_config = Namespace(includes=None, excludes=None, level=1, log_level='DEBUG')
    test = CISAudit(config=custom_config)
