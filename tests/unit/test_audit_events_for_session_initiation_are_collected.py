...
@patch.object(CISAudit, "_shellexec", mock_audit_events_for_session_initiation_are_collected_pass)
...
@patch.object(CISAudit, "_shellexec", mock_audit_events_for_session_initiation_are_collected_fail)
